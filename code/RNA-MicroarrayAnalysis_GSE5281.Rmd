...
img_data <- knitr::image_uri("/Users/mirandapestrofa/Downloads/MultimodalAnalysisAD/RNAdata_Histogram_rawData.png")
```
...
# This converts your local image into a Base64 string and displays it
# No external path will be needed after the HTML is generated
img_data1 <- knitr::image_uri("/Users/mirandapestrofa/Downloads/MultimodalAnalysisAD/RNAdata_Histogram_logtransdata.png")
```
...
# This converts your local image into a Base64 string and displays it
# No external path will be needed after the HTML is generated
img_data2 <- knitr::image_uri("/Users/mirandapestrofa/Downloads/MultimodalAnalysisAD/RNAdata_Histogram_exprhighconf_logtransdata.png")
```
...
# This converts your local image into a Base64 string and displays it
# No external path will be needed after the HTML is generated
img_data3 <- knitr::image_uri("/Users/mirandapestrofa/Downloads/MultimodalAnalysisAD/MeanVarianceQCBeforeLimma_ExprHighConf.png")
```
...
# This converts your local image into a Base64 string and displays it
# No external path will be needed after the HTML is generated
img_data4 <- knitr::image_uri("/Users/mirandapestrofa/Downloads/MultimodalAnalysisAD/results/plots/volcano/volcano_EC.png")
```
...
# This converts your local image into a Base64 string and displays it
# No external path will be needed after the HTML is generated
img_data5 <- knitr::image_uri("/Users/mirandapestrofa/Downloads/MultimodalAnalysisAD/results/plots/volcano/volcano_VCX.png")
```
...
# This converts your local image into a Base64 string and displays it
# No external path will be needed after the HTML is generated
img_data6 <- knitr::image_uri("/Users/mirandapestrofa/Downloads/MultimodalAnalysisAD/results/plots/heatmap/HeatMap_TopVarGenes.png")
```
...
# This converts your local image into a Base64 string and displays it
# No external path will be needed after the HTML is generated
img_data7 <- knitr::image_uri("/Users/mirandapestrofa/Downloads/MultimodalAnalysisAD/results/plots/heatmap/HeatmapOfAD-relevantGenes.png")
```
